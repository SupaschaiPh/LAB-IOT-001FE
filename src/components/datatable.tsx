...
export default function Datatable ({rowData,columnDefs,isLoading,gref,onEdit = (e)=>{},onSelect=(e)=>{}}:DatatableI){
    return (
        ...
        >
          ...
          <AgGridReact
              rowStyle={{flex: 1}}
              rowData={rowData}
              columnDefs={columnDefs ?? Object.keys(rowData[0])?.map((r)=>({
                field:r
              }))}
              defaultColDef={{flex: 1,filter: true,editable: true,floatingFilter: true}}
